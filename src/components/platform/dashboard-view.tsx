...
export function DashboardView() {
  const { novels, setNovels, setCurrentView, setSelectedNovel, setIsCreatingNovel } = useAppStore();
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      {/* Hero Banner */}
      <div className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 dark:from-amber-950/30 dark:via-orange-950/20 dark:to-amber-950/40">
        ...
        <div className="relative flex flex-col gap-4 p-8 md:p-12">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-2xl font-bold tracking-tight">Hermes Writer</h1>
              <p className="text-sm text-muted-foreground">AI 全流程网文创作平台</p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <Button variant="outline" onClick={() => setCurrentView("agents")}>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Button variant="ghost" size="sm" onClick={() => setCurrentView("novels")}>
          ...
          <Card className="border-dashed">
            <CardContent className="flex flex-col items-center justify-center py-16 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mb-4">创建你的第一部网文，让 Hermes Agent 助力你的创作</p>
                <Button onClick={() => setIsCreatingNovel(true)}>
                  <Plus className="size-4 mr-2" />
                  开始创作
                </Button>
              ...
              >
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    ...
                    <Badge variant="secondary" className={NOVEL_STATUS_MAP[novel.status as keyof typeof NOVEL_STATUS_MAP]?.color}>
                      {NOVEL_STATUS_MAP[novel.status as keyof typeof NOVEL_STATUS_MAP]?.label || novel.status}
                    </Badge>
                  </div>
                  {novel.genre && (
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Progress value={novel.status === "completed" ? 100 : Math.min(30, (novel._count?.chapters || 0) * 5)} className="h-1.5" />
                  </div>
                </CardContent>
              </Card>
            ))}
